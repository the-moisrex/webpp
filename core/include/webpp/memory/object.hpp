...
namespace webpp::object {
    ...
    struct object : public alloc::alloc_finder<T, FPack, AllocDescList>::new_type {
      ...
      protected:
        ...
        template <typename... Args>
        static constexpr bool support_alloc_args =
            requires(allocator_type const& the_alloc, Args... args)
        {
        ...
        template <typename... Args>
        static constexpr bool support_args_alloc =
            requires(allocator_type const& the_alloc, Args... args)
        {
        ...
        template <typename... Args>
        static constexpr bool support_tag_args =
            requires(Args... args)
        {
        ...
        template <typename... Args>
        static constexpr bool support_args =
            requires(Args... args)
        {
