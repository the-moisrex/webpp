// Automatically generated by convert-urltestdata-to-cpp.js on 2026-06-04T15:00:52.271Z
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://user:pass@foo:21/bar;par?b#c)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/bar;par") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "b") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat7) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http:foo.com)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat9) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL( foo.com  )URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat10) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(a:	 foo.com)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), " foo.com") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat11) {
    ...
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%20b%20") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%20d%20") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat12) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "x x") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat13) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://f:/c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "f") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/c") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat14) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://f:0/c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat15) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://f:00000000000000/c)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat16) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://f:00000000000000000000080/c)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat17) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://f:b/c)URL", R"URL(http://example.org/foo/bar)URL");
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat21) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://f:999999/c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat22) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(non-special://f:999999/c)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat24) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/bar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat25) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(  	)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat28) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/:") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat29) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/:a") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat39) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/:23") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat40) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/:23)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/:23") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat42) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(\\x\hello)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/hello") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat45) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(foo://)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat46) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://a:b@c:29/d)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/d") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat47) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http::@c:29)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/:@c:29") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat49) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://::@c@d:2)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat53) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http:\\a\b:c\d@foo.com\)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/b:c/d@foo.com/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat55) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(foo:/bar.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "foo") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/bar.com/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat59) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(c:/foo)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat60) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(//foo/bar)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "foo") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/bar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat61) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://foo/path;a??e#f#g)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "foo") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/path;a") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "?e") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat62) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://foo/abcd?efgh?ijkl)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "foo") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/abcd") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "efgh?ijkl") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat63) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://foo/abcd#foo?bar)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat64) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL([61:24:74]:98)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/[61:24:74]:98") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat65) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http:[61:27]/:foo)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/[61:27]/:foo") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat66) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[1::2]:3:4)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat67) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://2001::1)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat69) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://2001::1]:80)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat73) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://[0:0:0:0:0:0:13.1.68.3])URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat75) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/example.com/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat76) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(ftp:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat78) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(madeupscheme:/example.com/)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat79) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat84) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(ftps:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat86) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(ws:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat87) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(wss:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat88) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(data:/example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat89) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(javascript:/example.com/)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat91) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/example.com/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat93) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(https:example.com/)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat102) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/a/b/c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/a/b/c") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat103) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/a/ /c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/a/%20/c") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat104) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/a%2fc)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/a%2fc") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat105) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/a/%2f/c)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/a/%2f/c") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat107) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(data:text/html,test#test)URL",
      R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "data") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "text/html,test") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SeeReadmeMdForADescriptionOfTheFormat108) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(tel:1234567890)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "1234567890") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpsFelixfbeckerGithubIoWhatwgUrlCustomHostRepro1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(ssh://example.com/foo/bar.git)URL",
      R"URL(http://example.org/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/bar.git") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:c:\foo\bar.html)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/c:/foo/bar.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(  File:c|////foo\bar.html)URL",
      R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(C|/foo/bar)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/C:/foo/bar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml6) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(//server/file)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/file") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml9) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:///foo/bar.txt)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/bar.txt") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml10) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:///home/me)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/home/me") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml14) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file://test)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml15) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file://localhost)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml17) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file://localhost/test)URL", R"URL(file:///tmp/mock/path)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlFileHtml18) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/tmp/mock/test") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs8) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/ton") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs9) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/a") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs11) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/ton") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs13) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo/%2e%2") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs14) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://example.com/foo/%2e./%2e%2e/.%2e/%2e.bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%2e.bar") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs19) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%20foo") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs21) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%2") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs22) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%2zbar") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs23) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%2%C3%82%C2%A9zbar") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs24) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%41%7a") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs25) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%C2%91%91") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs26) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%00%51") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs27) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/(%28:%3A%29)") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs28) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%3A%3a%3C%3c") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs29) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foobar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs31) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%7Ffp3%3Eju%3Dduvgw%3Dd") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs32) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/@asdf%40") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs33) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%E4%BD%A0%E5%A5%BD%E4%BD%A0%E5%A5%BD") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs34) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%E2%80%A5/foo") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs35) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%EF%BB%BF/foo") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsPathJs36) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%E2%80%AE/foo/%E2%80%AD/bar") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsRelativeJs1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "bar=baz") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsRelativeJs6) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/foo%2Ehtml") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasedOnHttpTracWebkitOrgBrowserTrunkLayouttestsFastUrlScriptTestsRelativeJs7) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "www") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/test.txt)URL", R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "www.example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test.txt") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others8) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(../aaa/test.txt)URL", R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "www.example.com") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/aaa/test.txt") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others10) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(中/test.txt)URL", R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%E4%B8%AD/test.txt") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others11) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://www.example2.com)URL",
      R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others13) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:...)URL", R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Others15) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:a)URL", R"URL(http://www.example.com/test)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasicCanonicalizationUppercaseShouldBeConvertedToLowercase1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://ExAmPlE.CoM)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BasicCanonicalizationUppercaseShouldBeConvertedToLowercase2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://example example.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BasicCanonicalizationUppercaseShouldBeConvertedToLowercase3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://Goo%20 goo%7C|.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, U3000IsMappedToU0020SpaceWhichIsDisallowed1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://GOO 　goo.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest,
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://www.foo。bar.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, InvalidUnicodeCharactersShouldFailUFdd0IsDisallowedEfB790IsUFdd01) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://﷐zyx.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, ThisIsTheSameAsPreviousButEscaped1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://%ef%b7%90zyx.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, UFffd3) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%EF%BF%BD") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%EF%BF%BD") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
...
TYPED_TEST(URIWhatwgTest,
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://Ｇｏ.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, UrlSpecForbidsTheFollowingHttpsWwwW3OrgBugsPublicShowBugCgiId242571) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://％４１.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, UrlSpecForbidsTheFollowingHttpsWwwW3OrgBugsPublicShowBugCgiId242572) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://%ef%bc%85%ef%bc%94%ef%bc%91.com)URL",
      R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, 00InFullwidthShouldFailAlsoAsEscapedUtf8Input1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://％００.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, 00InFullwidthShouldFailAlsoAsEscapedUtf8Input2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://%ef%bc%85%ef%bc%90%ef%bc%90.com)URL",
      R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BasicIdnSupportUtf8AndUtf16InputShouldBeConvertedToIdn1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://你好你好)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest,
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://%zz%66%a.com)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, IfWeGetAnInvalidCharacterThatHasBeenEscaped2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://hello%00)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, EscapedNumbersShouldBeTreatedLikeIpAddressesIfTheyAre1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://%30%78%63%30%2e%30%32%35%30.01)URL",
      R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, EscapedNumbersShouldBeTreatedLikeIpAddressesIfTheyAre2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://%30%78%63%30%2e%30%32%35%30.01%2e)URL",
      R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, EscapedNumbersShouldBeTreatedLikeIpAddressesIfTheyAre3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://192.168.0.257)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, InvalidEscapingInHostsCausesFailure1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://%3g%78%63%30%2e%30%32%35%30%2E.01)URL",
      R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, ASpaceInAHostCausesFailure1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://192.168.0.1 hello)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv62) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[google.com])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv63) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[::1.2.3.4x])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv64) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[::1.2.3.])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv65) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[::1.2.])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv67) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[::1.])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv69) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[::%31])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, BrokenIpv610) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://%5B::1])URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, MiscUnicode1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://foo:💩@example.com/bar)URL",
      R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
...
TYPED_TEST(URIWhatwgTest, ResolvingAFragmentAgainstAnySchemeSucceeds2) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "x@x.com") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ResolvingAFragmentAgainstAnySchemeSucceeds6) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "test") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "test") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, MultipleInAuthorityState1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(https://@test@test@example:800/)URL",
      R"URL(http://doesnotmatter/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
...
TYPED_TEST(URIWhatwgTest, MultipleInAuthorityState2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(https://@@@example)URL", R"URL(http://doesnotmatter/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
...
TYPED_TEST(URIWhatwgTest, NonAz09Characters1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%60%7B%7D") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "`{}") << details;
...
TYPED_TEST(URIWhatwgTest, ByteIsAndUrlIsSpecial1) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%27") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, CredentialsInBase1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/some/path)URL", R"URL(http://user@example.org/smth)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "user") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/some/path") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, CredentialsInBase2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL()URL", R"URL(http://user:pass@example.org:21/smth)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "user") << details;
    EXPECT_EQ(uri::password(ctx.out), "pass") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "example.org") << details;
    EXPECT_EQ(uri::port(ctx.out), "21") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/smth") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, CredentialsInBase3) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(/some/path)URL",
      R"URL(http://user:pass@example.org:21/smth)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "user") << details;
    EXPECT_EQ(uri::password(ctx.out), "pass") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes3) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/pa/i") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes4) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/i") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes18) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/pa/pa") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "i") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes19) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "ho") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/pa") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "i") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes21) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "sd") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, ASetOfTestsDesignedByZcorpanForRelativeUrlsWithUnknownSchemes22) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "sd/sd") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "i") << details;
...
TYPED_TEST(URIWhatwgTest, UnknownSchemeWithPathLookingLikeAPassword1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), ":a@example.net") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, UnknownSchemeWithBogusPercentEncoding1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "%NBD") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, UnknownSchemeWithBogusPercentEncoding2) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "%1G") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, UnknownSchemeWithNonUrlCharacters1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "%EF%BF%BF") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, UnknownSchemeWithNonUrlCharacters2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://example.com/�𐟾�﷐﷏﷯ﷰ￾￿?�𐟾�﷐﷏﷯ﷰ￾￿)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out),
                  "%EF%BF%BD%F0%90%9F%BE%EF%BF%BD%EF%B7%90%EF%B7%8F%EF%B7%AF%EF%B7%B0%EF%BF%BE%EF%BF%BF")
          << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
...
TYPED_TEST(URIWhatwgTest, AllowedHostDomainCodePoints2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(sc://!"$%&'()*+,-.;=_`{}~/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "sc") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, TestsFromJsdomWhatwgUrlDesignedForCodeCoverage1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://127.0.0.1:10100/relative_import.html)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/relative_import.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, TestsFromJsdomWhatwgUrlDesignedForCodeCoverage2) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "foo=%7B%22abc%22") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, TestsFromJsdomWhatwgUrlDesignedForCodeCoverage3) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/jqueryui@1.2.3") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
g)URL");
    ...
    EXPECT_EQ(uri::render_queries(ctx.out), "query") << details;
...
TYPED_TEST(URIWhatwgTest, StringificationOfUrlSearchparams1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(?a=b&c=d)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/foo/bar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "a=b&c=d") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SchemeOnly1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http:)URL", R"URL(http://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SchemeOnly2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http:)URL", R"URL(https://example.org/foo/bar)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, SchemeOnly3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(sc:)URL", R"URL(https://example.org/foo/bar)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "sc") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodingOfFragments1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/baz") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "qux") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull103171) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://1.2.3.4/)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull103173) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://192.168.257)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull103175) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://192.168.257.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull103177) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://256.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull103178) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://999999999)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031710) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://999999999.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031711) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://10000000000)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031712) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://10000000000.com)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031713) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://4294967295)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031714) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://4294967296)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031715) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://0xffffffff)URL", R"URL(http://other.com/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031716) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://0xffffffff1)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, Ipv4ParsingViaHttpsGithubComNodejsNodePull1031717) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://256.256.256.256)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, FileUrlsContainingPercentEncodedWindowsDriveLettersShouldnTWork1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/C%3A/") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsContainingPercentEncodedWindowsDriveLettersShouldnTWork2) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/C%7C/") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, MoreFileUrlTestsByZcorpanAndAnnevk10) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "x") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsAndManyBackSlashes7) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/localhost//cat") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsAndManyBackSlashes10) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "///mouse") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsAndManyBackSlashes11) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/pig") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsAndManyBackSlashes14) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(/..//localhost//pig)URL", R"URL(file://lion/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "//localhost//pig") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsWithNonEmptyHosts1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/rooibos") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsWithNonEmptyHosts2) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "chai") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, WindowsDriveLetterHandlingWithTheFileBaseUrl2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(C|)URL", R"URL(file://host/D:/dir1/dir2/file)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, WindowsDriveLetterHandlingWithTheFileBaseUrl8) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "host") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/dir/C") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, WindowsDriveLetterHandlingWithTheFileBaseUrl9) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "host") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/dir/C|a") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, WindowsDriveLetterQuirkInTheFileSlashState3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(file:\c:\foo\bar)URL", R"URL(file:///c:/baz/qux)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileUrlsWithoutBaseUrlByRimasMiseviIus2) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "q=v") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FileDriveLetterCasesFromHttpsCrbugCom10786981) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/Y:") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, AdditionalFileUrlTestsForHttpsGithubComWhatwgUrlIssues4054) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/one/two") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, AdditionalFileUrlTestsForHttpsGithubComWhatwgUrlIssues4056) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/two") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
    EXPECT_EQ(uri::href(ctx), R"URL(file://one/two)URL") << details;
}
...
TYPED_TEST(URIWhatwgTest, FileUrlTestsForHttpsGithubComWhatwgUrlIssues5491) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "//p") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv6Tests1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://[1:0::])URL", R"URL(http://example.net/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv6Tests2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://[0:1:2:3:4:5:6:7:8])URL",
      R"URL(http://example.net/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, PortOverflow232811) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://f:4294967377/c)URL", R"URL(http://example.org/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, PortOverflow264811) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://f:18446744073709551697/c)URL",
      R"URL(http://example.org/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, PortOverflow2128811) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(http://f:340282366920938463463374607431768211537/c)URL",
      R"URL(http://example.org/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests11) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/someconfig;mode=netascii") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests13) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/Index.ut2") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests14) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(redis://foo:bar@somehost:6379/0?baz=bam&qux=baz)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/0") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "baz=bam&qux=baz") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests15) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/sup") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests17) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/channel") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "passwd") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests18) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(dns://fw.example.org:9999/foo.bar.org?type=TXT)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/foo.bar.org") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "type=TXT") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests19) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(ldap://localhost:389/ou=People,o=JNDITutorial)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/ou=People,o=JNDITutorial") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests21) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "ietf:rfc:2648") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialUrlPathTests22) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "joe@example.org,2001:foo/bar") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv6InNonSpecialUrls5) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "https://example.com:443/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv6InNonSpecialUrls6) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "http://example.org:88/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Ipv6InNonSpecialUrls7) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "d3958f5c-0777-0845-9dcf-2cb28783acaf") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BlobInBlob1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "blob:") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, BlobInBlob2) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "blob:https://example.org/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonHttpSInBlob1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "about:blank") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonHttpSInBlob2) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "file://host/path") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonHttpSInBlob3) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "ftp://host/path") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonHttpSInBlob4) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "ws://example.org/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonHttpSInBlob5) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "wss://example.org/") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedHttpInBlob1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "http%3a//example.org/") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment1) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%22") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment3) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%3C") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment4) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%3E") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment5) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%E2%8C%A3") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment6) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%23%23") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment7) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%GH") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, PercentEncodedQueryAndFragment8) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "a") << details;
...
TYPED_TEST(URIWhatwgTest, OtherBaseUrlTestsThatMustSucceed1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test-a-colon-slash.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, OtherBaseUrlTestsThatMustSucceed2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(test-a-colon-slash-slash.html)URL", R"URL(a://)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "a") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test-a-colon-slash-slash.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, OtherBaseUrlTestsThatMustSucceed3) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test-a-colon-slash-b.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, OtherBaseUrlTestsThatMustSucceed4) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(test-a-colon-slash-slash-b.html)URL", R"URL(a://b)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "a") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/test-a-colon-slash-slash-b.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FirstSchemeCharNotAllowedHttpsGithubComWhatwgUrlIssues4641) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(10.0.0.7:8080/foo.html)URL",
      R"URL(file:///some/dir/bar.html)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/some/dir/10.0.0.7:8080/foo.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SubsequentSchemeCharsNotAllowed1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(a!@$*=/foo.html)URL", R"URL(file:///some/dir/bar.html)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "file") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/some/dir/a!@$*=/foo.html") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, FirstAndSubsequentSchemeCharsAllowed1) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(a1234567890-+.:foo/bar)URL",
      R"URL(http://example.com/dir/file)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, IdnaHostnamesWhichGetMappedToLocalhost1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/usr/bin") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, HttpsBugzillaMozillaOrgShowBugCgiId16470581) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(#link)URL", R"URL(https://example.org/##link)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Utf8PercentEncodeOfC0ControlPercentEncodeSetAndSupersets1) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "cannot-be-a-base-url-%00%01%1F%1E~%7F%C2%80") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, Utf8PercentEncodeOfC0ControlPercentEncodeSetAndSupersets2) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(https://www.example.com/path{path.html?query'=query#fragment<fragment)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/path%7B%7Fpath.html") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "query%27%7F=query") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
...
TYPED_TEST(URIWhatwgTest, Utf8PercentEncodeOfC0ControlPercentEncodeSetAndSupersets3) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(https://user:pass[@foo/bar)URL",
      R"URL(http://example.org)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "https") << details;
    EXPECT_EQ(uri::username(ctx.out), "user") << details;
...
TYPED_TEST(URIWhatwgTest, TestsForTheDistinctPercentEncodeSets3) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(foo://joe: !"$%&'()*+,-.:;<=>@[\]^_`{|}~@host/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "foo") << details;
...
TYPED_TEST(URIWhatwgTest, TestsForTheDistinctPercentEncodeSets4) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(wss://joe: !"$%&'()*+,-.:;<=>@[]^_`{|}~@host/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "wss") << details;
    EXPECT_EQ(uri::username(ctx.out), "joe") << details;
...
TYPED_TEST(URIWhatwgTest, TestsForTheDistinctPercentEncodeSets7) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%20!%22$%&'()*+,-./:;%3C=%3E@[\\]^_%60%7B|%7D~") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, TestsForTheDistinctPercentEncodeSets9) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(foo://host/dir/? !"$%&'()*+,-./:;<=>?@[\]^_`{|}~)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "foo") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    EXPECT_EQ(uri::hostname(ctx.out), "host") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/dir/") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%20!%22$%&'()*+,-./:;%3C=%3E?@[\\]^_`{|}~") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, TestsForTheDistinctPercentEncodeSets10) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(wss://host/dir/? !"$%&'()*+,-./:;<=>?@[\]^_`{|}~)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "wss") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/dir/") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%20!%22$%&%27()*+,-./:;%3C=%3E?@[\\]^_`{|}~") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, EnsureThatInputSchemesAreNotIgnoredWhenResolvingNonSpecialUrls1) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "rootless") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, EnsureThatInputSchemesAreNotIgnoredWhenResolvingNonSpecialUrls4) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/rooted") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, LastComponentLooksLikeANumberButNotValidIpv41) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://1.2.3.4.5)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, LastComponentLooksLikeANumberButNotValidIpv45) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(http://256.256.256.256.256)URL", R"URL(http://other.com/)URL");
    EXPECT_FALSE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
}
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces2) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%00y") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces6) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%EF%BF%BFy") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces7) {
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_queries(ctx.out), "%EF%BF%BFy") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces10) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "x/%00y") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces14) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "x/%EF%BF%BFy") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, U0000AndUFfffInVariousPlaces18) {
    ...
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    if constexpr (TypeParam::is_modifiable) {
        EXPECT_EQ(uri::render_path(ctx.out), "/%22quoted%22") << details;
    } else {
        EXPECT_TRUE(has(ctx.status, uri::uri_status::modification_required));
    }
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial1) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(data://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "data") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
    ...
    EXPECT_EQ(uri::render_path(ctx.out), "/pathname") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "search") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial3) {
    ...
    EXPECT_EQ(uri::hostname(ctx.out), "test") << details;
    EXPECT_EQ(uri::port(ctx.out), "") << details;
    EXPECT_EQ(uri::render_path(ctx.out), "/b") << details;
    EXPECT_EQ(uri::render_queries(ctx.out), "") << details;
    EXPECT_EQ(uri::fragment(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial7) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(javascript://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "javascript") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial13) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(mailto://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "mailto") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial19) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(intent://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial25) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(urn://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "urn") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial31) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(turn://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, NonSpecialSchemesThatSomeImplementationsMightIncorrectlyTreatAsSpecial37) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(stun://example.com:8080/pathname?search#hash)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
...
TYPED_TEST(URIWhatwgTest, SchemeRelativePathStartingWithMultipleSlashes2) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(///\//\//test)URL", R"URL(http://example.org/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SchemeRelativePathStartingWithMultipleSlashes5) {
    ...
    auto const            ctx =
      this->template parse_from_string<TypeParam>(R"URL(///example.org/../../)URL", R"URL(http://example.org/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
    EXPECT_EQ(uri::password(ctx.out), "") << details;
...
TYPED_TEST(URIWhatwgTest, SchemeRelativePathStartingWithMultipleSlashes7) {
    ...
    auto const            ctx     = this->template parse_from_string<TypeParam>(
      R"URL(///example.org/../path/../../path)URL",
      R"URL(http://example.org/)URL");
    EXPECT_TRUE(uri::is_valid(ctx.status)) << to_string(uri::get_value(ctx.status)) << details;
    EXPECT_EQ(uri::scheme(ctx.out), "http") << details;
    EXPECT_EQ(uri::username(ctx.out), "") << details;
