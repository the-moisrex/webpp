...
TEST(TimeConvert, ToTimeval) {
    timeval tv50{.tv_sec = 0, .tv_usec = 50'000u};
    EXPECT_EQ(tv50.tv_sec, to_timeval(50ms).tv_sec);
    EXPECT_EQ(tv50.tv_usec, to_timeval(50ms).tv_usec);

    EXPECT_EQ(tv50.tv_sec, to_timeval(50'000us).tv_sec);
    EXPECT_EQ(tv50.tv_usec, to_timeval(50'000us).tv_usec);
