...
namespace {
    constexpr auto valid_domains = stl::array{
      "example.com",
      "google.com",
      "github.com",
      "wikipedia.org",
    ...
    constexpr auto invalid_domains = stl::array{
      "-example.com",
      "example-.com",
      "example.com-",
      "example..com",
    ...
    constexpr std::array<std::pair<std::string_view, std::string_view>, 60> puny_domains = {
