...
namespace webpp {
    ...
    static constexpr ipv6 ipv6_localhost{{0ull, 1ull}}; // ::1

    static constexpr ipv4 ipv4_all{0u, 0u, 0u, 0u};
    static constexpr ipv6 ipv6_all{{0ull, 0ull}}; // ::
    ...
    standard_endpoints(ip_endpoint::protocol proto, auto ip, stl::uint16_t port) noexcept {
        return stl::array<ip_endpoint, 1>{ip_endpoint{proto, ip, port}};
    }

    [[nodiscard]] consteval auto standard_endpoints(ip_endpoint::protocol proto,
                                                    IPAddress auto&&... ip) noexcept {
        return stl::array<ip_endpoint, sizeof...(ip) * 2>{ip_endpoint{proto, ip, default_http_port}...,
                                                          {proto, ip, default_https_port}...};
    }

    [[nodiscard]] consteval auto standard_endpoints(stl::uint16_t port, IPAddress auto&&... ip) noexcept {
        return stl::array<ip_endpoint, sizeof...(ip) * 2>{ip_endpoint{ip_endpoint::tcp, ip, port}...,
    ...
    [[nodiscard]] consteval auto standard_endpoints(ip_endpoint::protocol proto) noexcept {
        return stl::array<ip_endpoint, 4>{ip_endpoint{proto, ipv4_all, default_http_port},
    ...
    namespace tcp {
        // http port
        static constexpr ip_endpoint ipv4_localhost_http_endpoint{ip_endpoint::tcp,
                                                                  ipv4_localhost,
                                                                  default_http_port};
        static constexpr ip_endpoint ipv6_localhost_http_endpoint{ip_endpoint::tcp,
                                                                  ipv6_localhost,
                                                                  default_http_port};

        // https port
        static constexpr ip_endpoint ipv4_localhost_https_endpoint{ip_endpoint::tcp,
                                                                   ipv4_localhost,
                                                                   default_https_port};
        static constexpr ip_endpoint ipv6_localhost_https_endpoint{ip_endpoint::tcp,
                                                                   ipv6_localhost,
                                                                   default_https_port};
        ...
        static constexpr ip_endpoint_array<4> all_endpoint{ipv4_all_https_endpoint,
                                                           ipv4_all_http_endpoint,
        ...
        static constexpr ip_endpoint_array<4> localhost_endpoint{ipv4_localhost_https_endpoint,
                                                                 ipv4_localhost_http_endpoint,
    ...
    namespace udp {
        // http port
        static constexpr ip_endpoint ipv4_localhost_http_endpoint{ip_endpoint::udp,
                                                                  ipv4_localhost,
                                                                  default_http_port};
        static constexpr ip_endpoint ipv6_localhost_http_endpoint{ip_endpoint::udp,
                                                                  ipv6_localhost,
                                                                  default_http_port};

        // https port
        static constexpr ip_endpoint ipv4_localhost_https_endpoint{ip_endpoint::udp,
                                                                   ipv4_localhost,
                                                                   default_https_port};
        static constexpr ip_endpoint ipv6_localhost_https_endpoint{ip_endpoint::udp,
                                                                   ipv6_localhost,
                                                                   default_https_port};
