...
namespace webpp::http {
    ...
    struct [[nodiscard]] cgi_request final : CommonHTTPRequest {
        ...
        explicit cgi_request(ReqT& svr) : CommonHTTPRequest{svr} {}
         ...
         */
        [[nodiscard]] stl::string_view env(char const* key) const noexcept {
         ...
         */
        [[nodiscard]] stl::string_view method() const noexcept {
         ...
         */
        [[nodiscard]] stl::string_view uri() const noexcept {
