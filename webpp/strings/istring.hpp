...
namespace webpp {
    ...
    struct istring : public stl::remove_cvref_t<StringType> {
        ...
        using char_traits_type = istl::char_traits_type_of_t<string_type>;
      ...
      public:
        ...
        explicit(false) constexpr istring(Args&&... args) noexcept(noexcept(string_type(stl::forward<Args>(args)...)))
        ...
        auto splitter(DelimT&&... delims) const noexcept {
            return strings::splitter{std_string_view(), stl::forward<DelimT>(delims)...};
        }
    };
