...
extern char const elf_interpreter[] __attribute__((section(".interp"))) = ELF_INTERPRETER_PATH;
#    else  // ELF_INTERPRETER_PATH
extern char const elf_interpreter[] __attribute__((section(".interp"))) = "/lib64/ld-linux-x86-64.so.2";
