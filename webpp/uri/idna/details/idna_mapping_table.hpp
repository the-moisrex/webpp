 ...
 *   This file's generation date:  Thu, 16 Jan 2025 03:21:02 GMT
    ...
    static constexpr std::array<std::array<std::uint16_t, 256ULL>, 69ULL> idna_ref_blocks{
      {
       ...
       // Block #3
        {{valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          ...
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, 0xf7,  0xf8,  valid, 0xf9,  0xfa,       0xfb,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      0x1c,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      0xfc,       valid, 0xfd,  valid, 0xfe,  valid, 0xff,       valid,
          disallowed, disallowed, 0x100,      valid, valid, valid, 0x101, 0x102, disallowed, disallowed,
          disallowed, disallowed, 0x20,       0x103, 0x104, 0x105, 0x106, 0x107, 0x108,      disallowed,
          0x109,      disallowed, 0x10a,      0x10b, valid, 0x10c, 0x10d, 0x10e, 0x10f,      0x110,
          0x111,      0x112,      0x113,      0xfb,  0x114, 0x115, 0x21,  0x116, 0x117,      0x118,
          0x119,      0x11a,      disallowed, 0x11b, 0x11c, 0x11d, 0x11e, 0x11f, 0x120,      0x121,
          0x122,      0x123,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, valid, valid,      valid,
          valid,      valid,      valid,      valid, valid, valid, valid, 0x124, 0x10d,      0x113,
          0x11d,      0x10a,      0x123,      0x11e, 0x119, valid, 0x125, valid, 0x126,      valid,
          0x127,      valid,      0x128,      valid, 0x129, valid, 0x12a, valid, 0x12b,      valid,
          0x12c,      valid,      0x12d,      valid, 0x12e, valid, 0x12f, valid, 0x130,      valid,
          0x114,      0x11a,      0x11b,      valid, 0x113, 0x110, valid, 0x131, valid,      0x11b,
          0x132,      valid,      valid,      0x133, 0x134, 0x135}},
       // Block #4
       ...
       // Block #14
        {{valid, valid,      valid,      valid,      valid,      valid,      valid,      valid,
          ...
          valid, valid,      valid,      valid,      valid,      valid,      valid,      valid,
          valid, valid,      valid,      valid,      valid,      valid,      disallowed, disallowed,
          0x249, 0x24a,      0x24b,      0x24c,      0x24d,      0x24e,      disallowed, disallowed}},
       // Block #15
        {{valid,      valid,      valid,      valid,      valid,      valid,      valid,      valid,
          valid,      valid,      valid,      valid,      valid,      valid,      valid,      valid,
          valid,      valid,      valid,      valid,      valid,      valid,      disallowed, disallowed,
       ...
       // Block #27
        {{0x411, 0x412, 0x413, 0x414, 0x415,      0x416,      0x417,      0x418,      0x419,      0x41a,
          ...
          0x439, 0x43a, 0x43b, 0x43c, 0x43d,      0x43e,      0x43f,      0x440,      valid,      valid,
          valid, valid, valid, valid, valid,      valid,      valid,      valid,      valid,      valid,
          valid, valid, valid, valid, valid,      valid,      valid,      valid,      valid,      valid,
          valid, valid, valid, valid, valid,      valid,      valid,      valid,      valid,      valid,
          valid, valid, valid, valid, valid,      valid,      valid,      valid,      valid,      valid,
          valid, valid, valid, valid, valid,      valid,      0x441,      valid,      0x442,      0x443,
          0x444, valid, valid, 0x445, valid,      0x446,      valid,      0x447,      valid,      0x27f,
          0x291, 0x27e, 0x286, valid, 0x448,      valid,      valid,      0x449,      valid,      valid,
          valid, valid, valid, valid, 0x9,        0x15,       0x44a,      0x44b,      0x44c,      valid,
          0x44d, valid, 0x44e, valid, 0x44f,      valid,      0x450,      valid,      0x451,      valid,
          0x452, valid, 0x453, valid, 0x454,      valid,      0x455,      valid,      0x456,      valid,
          0x457, valid, 0x458, valid, 0x459,      valid,      0x45a,      valid,      0x45b,      valid,
          0x45c, valid, 0x45d, valid, 0x45e,      valid,      0x45f,      valid,      0x460,      valid,
          0x461, valid, 0x462, valid, 0x463,      valid,      0x464,      valid,      0x465,      valid,
          0x466, valid, 0x467, valid, 0x468,      valid,      0x469,      valid,      0x46a,      valid,
          0x46b, valid, 0x46c, valid, 0x46d,      valid,      0x46e,      valid,      0x46f,      valid,
          0x470, valid, 0x471, valid, 0x472,      valid,      0x473,      valid,      0x474,      valid,
          0x475, valid, 0x476, valid, 0x477,      valid,      0x478,      valid,      0x479,      valid,
          0x47a, valid, 0x47b, valid, 0x47c,      valid,      0x47d,      valid,      valid,      valid,
          valid, valid, valid, valid, valid,      0x47e,      valid,      0x47f,      valid,      valid,
          valid, valid, 0x480, valid, disallowed, disallowed, disallowed, disallowed, disallowed, valid,
       ...
       // Block #32
        {{disallowed, disallowed, disallowed, disallowed, disallowed, valid,      valid,      valid,
          ...
          valid,      valid,      valid,      valid,      valid,      valid,      valid,      valid}},
       // Block #33
        {{0x5c9, 0x5ca, 0x5cb, 0x5cc, 0x5cd, 0x5ce,      0x5cf, 0x5d0, 0x5d1, 0x5d2, 0x5d3, 0x5d4, 0x5d5,
          0x5d6, 0x5d7, 0x5d8, 0x5d9, 0x5da, 0x5db,      0x5dc, 0x5dd, 0x5de, 0x5df, 0x5e0, 0x5e1, 0x5e2,
          0x5e3, 0x5e4, 0x5e5, 0x5e6, 0x5e7, disallowed, 0x5e8, 0x5e9, 0x5ea, 0x5eb, 0x5ec, 0x5ed, 0x5ee,
          ...
          0x609, 0x60a, 0x60b, 0x60c, 0x60d, 0x4c6,      0x60e, valid, valid, valid, valid, valid, valid,
          valid, valid, 0x60f, 0x610, 0x611, 0x612,      0x613, 0x614, 0x615, 0x616, 0x617, 0x618, 0x619,
          0x61a, 0x61b, 0x61c, 0x61d, 0x61e, 0x562,      0x565, 0x568, 0x56a, 0x572, 0x573, 0x576, 0x578,
          0x579, 0x57b, 0x57c, 0x57d, 0x57e, 0x57f,      0x61f, 0x620, 0x621, 0x622, 0x623, 0x624, 0x625,
          0x626, 0x627, 0x628, 0x629, 0x62a, 0x62b,      0x62c, 0x62d, 0x62e, 0x62f, valid, 0x484, 0x48a,
          0x5bf, 0x5c0, 0x630, 0x631, 0x632, 0x48f,      0x633, 0x49b, 0x4cd, 0x4d9, 0x4d8, 0x4ce, 0x52a,
          0x4a3, 0x4cb, 0x634, 0x635, 0x636, 0x637,      0x638, 0x639, 0x63a, 0x63b, 0x63c, 0x63d, 0x4a9,
          0x63e, 0x63f, 0x640, 0x641, 0x642, 0x643,      0x644, 0x645, 0x5c1, 0x5c2, 0x5c3, 0x646, 0x647,
          0x648, 0x649, 0x64a, 0x64b, 0x64c, 0x64d,      0x64e, 0x64f, 0x650, 0x651, 0x652, 0x653, 0x654,
          0x655, 0x656, 0x657, 0x658, 0x659, 0x65a,      0x65b, 0x65c, 0x65d, 0x65e, 0x65f, 0x660, 0x661,
          0x662, 0x663, 0x664, 0x665, 0x666, 0x667,      0x668, 0x669, 0x66a, 0x66b, 0x66c, 0x66d, 0x66e,
          0x66f, 0x670, 0x671, 0x672, 0x673, 0x674,      0x675, 0x676, 0x677, 0x678, 0x679, 0x67a, 0x67b,
          0x67c, 0x67d, 0x67e, 0x67f, 0x680, 0x681,      0x682, 0x683, 0x684, 0x685, 0x686, 0x687, 0x688,
          0x689, 0x68a, 0x68b, 0x68c, 0x68d, 0x68e,      0x68f, 0x690, 0x691, 0x692, 0x693, 0x694, 0x695,
          0x696, 0x697, 0x698, 0x699, 0x69a, 0x69b,      0x69c, 0x69d, 0x69e}},
       // Block #34
