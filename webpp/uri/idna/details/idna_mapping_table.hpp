 ...
 *   This file's generation date:  Fri, 17 Jan 2025 17:03:09 GMT
...
namespace webpp::uri::idna::details {
    ...
    static constexpr std::array<std::uint16_t, 3215ULL> idna_refs{
      blt | 0x0U,    0x0U,          0x40U,         0x80U,         0xC0U,         0xFFU,         0x13EU,
      0x17BU,        0x1B8U,        0x1F7U,        0x206U,        0x20FU,        blt | 0x0U,    0x248U,
      0x288U,        0x2B9U,        0x2EAU,        0x31AU,        0x34AU,        0x38AU,        0x3CAU,
      0x40AU,        0x443U,        blt | 0x40U,   blt | 0x80U,   0x44DU,        blt | 0x0U,    blt | 0xC0U,
      blt | 0x100U,  blt | 0x140U,  blt | 0x180U,  blt | 0x110U,  blt | 0x1C0U,  blt | 0x200U,  blt | 0x240U,
      blt | 0xBBU,   blt | 0x0U,    0x457U,        blt | 0x280U,  0x48BU,        0x4C5U,        0x502U,
      blt | 0x2BEU,  blt | 0x2FEU,  blt | 0x33DU,  0x532U,        blt | 0x380U,  blt | 0x3C0U,  blt | 0x400U,
      blt | 0x440U,  blt | 0x480U,  blt | 0x4C0U,  blt | 0x500U,  blt | 0x540U,  blt | 0x580U,  blt | 0x5C0U,
      0x571U,        blt | 0x600U,  0x5AEU,        0x5ECU,        0x62CU,        0x669U,        0x6A5U,
      blt | 0x640U,  blt | 0x0U,    blt | 0x0U,    0x6E2U,        0x720U,        blt | 0x0U,    0x75DU,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x680U,  blt | 0x6C0U,  blt | 0x700U,  blt | 0x740U,
      blt | 0x780U,  blt | 0x7C0U,  0x77BU,        blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x800U,
      blt | 0xFU,    blt | 0x840U,  blt | 0x880U,  0x79CU,        blt | 0x8C0U,  0x7D2U,        blt | 0xCU,
      ...
      blt | 0xB00U,  blt | 0x813U,  0x802U,        blt | 0xB40U,  0x842U,        0x882U,        0x8BBU,
      blt | 0x0U,    0x8F4U,        0x934U,        0x974U,        0x9B4U,        0x9F3U,        0xA32U,
      0xA72U,        0xAB2U,        0xAF2U,        0xB31U,        0xB70U,        blt | 0xB80U,  0xBB0U,
      0xBF0U,        0xC30U,        blt | 0x0U,    0xC44U,        blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      0xC49U,        blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0xBC0U,  0xC6FU,        0xCA4U,
      0xCE4U,        blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      0xD18U,        0xD19U,        blt | 0x0U,    0xD1DU,        blt | 0x0U,    blt | 0x117U,  blt | 0x86U,
      blt | 0x0U,    0xD54U,        0xD84U,        0xDB4U,        0xDF4U,        blt | 0xC00U,  0xE2DU,
      blt | 0xC40U,  blt | 0xC80U,  blt | 0x0U,    blt | 0xAB1U,  0xE65U,        0xE84U,        0xEA4U,
      0xEE4U,        0xF24U,        0xF64U,        0xFA4U,        blt | 0x9CU,   0xFDFU,        0xFFAU,
      0x101AU,       0x105AU,       0x109AU,       blt | 0xCC0U,  0x10DAU,       0x111AU,       0x115AU,
      0x119AU,       0x11DAU,       0x121AU,       0x125AU,       0x129AU,       blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      ...
      0x12DAU,       0x131AU,       blt | 0x10U,   0x1338U,       0x1356U,       0x1396U,       0x13D6U,
      blt | 0xD80U,  blt | 0x10U,   blt | 0x0U,    blt | 0xDC0U,  blt | 0x0U,    blt | 0xE00U,  blt | 0x0U,
      blt | 0xE40U,  blt | 0x17BU,  blt | 0xE80U,  blt | 0x0U,    blt | 0xEC0U,  blt | 0xF00U,  0x1410U,
      0x144AU,       blt | 0xF40U,  blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      ...
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  0x148AU,       0x14CAU,       0x150AU,       0x154AU,       0x158AU,
      0x15CAU,       0x160AU,       0x164AU,       0x168AU,       0x16CAU,       0x1708U,       0x1743U,
      0x1780U,       0x17C0U,       0x1800U,       0x1840U,       0x1880U,       0x18BEU,       0x18FCU,
      0x193CU,       0x197CU,       0x19BCU,       0x19FCU,       0x1A3BU,       0x1A7AU,       0x1ABAU,
      0x1AFAU,       0x1B39U,       blt | 0x1040U, blt | 0x1080U, blt | 0x0U,    blt | 0xDU,    blt | 0x10C0U,
      blt | 0x0U,    blt | 0x1100U, blt | 0x1140U, blt | 0xFFCU,  blt | 0xFFCU,  blt | 0x1180U, blt | 0x11C0U,
      blt | 0x832U,  blt | 0x1200U, blt | 0xBFU,   blt | 0x1240U, 0x1B78U,       blt | 0x0U,    0x1BA0U,
      0x1BC8U,       blt | 0x20U,   0x1BE0U,       0x1BF8U,       blt | 0x17EU,  blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x17BU,  blt | 0x1280U, 0x1C38U,       blt | 0xFFCU,  blt | 0x12C0U,
      ...
      blt | 0xFFCU,  blt | 0x0U,    blt | 0xFF3U,  0x1C78U,       blt | 0x1540U, blt | 0x1580U, 0x1CB8U,
      ...
      blt | 0xCU,    blt | 0xFFCU,  0x1CF8U,       blt | 0x1B00U, blt | 0x1B40U, blt | 0x1B80U, blt | 0x1BC0U,
      ...
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xEU,    blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  0x1D38U,       blt | 0xAB4U,  blt | 0xFFCU,  blt | 0x0U,    blt | 0xFBCU,
      ...
      0x1D6FU,       blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      ...
      blt | 0x0U,    blt | 0x0U,    0x1DA6U,       blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x17EU,  blt | 0xFFCU,  blt | 0xE0U,   blt | 0xD00U,  blt | 0x0U,
      blt | 0xFF8U,  blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x17CU,  blt | 0xE7U,   0x1DE6U,
      0x1E21U,       0x1E5CU,       blt | 0x0U,    blt | 0xFF6U,  blt | 0xFFCU,  blt | 0x2240U, blt | 0x0U,
      blt | 0x2280U, blt | 0xFFCU,  blt | 0xFFCU,  0x1E9CU,       0x1EDCU,       0x1F02U,       0x1F28U,
      0x1F68U,       0x1FA8U,       0x1FCEU,       0x1FDAU,       0x1FE6U,       0x1FF2U,       0x1FFEU,
      0x2024U,       0x202AU,       0x2030U,       0x2036U,       0x203CU,       blt | 0x0U,    blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
      ...
      blt | 0xFFCU,  blt | 0xFFCU,  0x207CU,       0x20BCU,       blt | 0x2130U, blt | 0xFFCU,  blt | 0x2340U,
      ...
      blt | 0x0U,    blt | 0x0U,    blt | 0x24C0U, 0x20FCU,       blt | 0x2500U, blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xACFU,  blt | 0x17DU,  blt | 0xFFCU,  blt | 0x2540U, blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  0x213CU,       0x217AU,       0x21B8U,       blt | 0x2580U, blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0x9C0U,  blt | 0x0U,    blt | 0x25C0U, blt | 0x2600U,
      0x21F7U,       0x2236U,       0x2266U,       blt | 0xADAU,  0x2296U,       0x22D6U,       blt | 0xFFCU,
      ...
      blt | 0x89U,   0x2316U,       blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      ...
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  0x2356U,       0x2396U,       0x23D6U,       0x2416U,       0x2456U,
      0x2496U,       0x24D6U,       0x2516U,       0x2556U,       blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,
      blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0xFFCU,  blt | 0x0U,
      blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,    blt | 0x0U,
     ...
     */
    static constexpr std::array<std::uint16_t, 4ULL> idna_refs_extra{0x2596U, 0x2596U, 0x2596U, 0x2596U};
     ...
     *
     * Table size: 19372 B or 18.92 KiB
     */
    static constexpr std::array<std::uint16_t, 9686ULL> idna_ref_blocks{
