...
namespace webpp::http {
    ...
    [[nodiscard]] static constexpr stl::string_view status_code_reason_phrase(status_code_type const code) noexcept {
        switch (code) {
    ...
    [[nodiscard]] static constexpr stl::string_view status_code_reason_phrase(status_code code) noexcept {
