...
[[nodiscard]] static constexpr std::uint32_t table_lookup(std::uint16_t const lhs, std::uint16_t const rhs) noexcept {
...
unsigned int multiply(unsigned short x, unsigned short y) noexcept {
    return ((x * 0x0101'0101'0101'0101ULL & 0x8040'2010'0804'0201ULL) * 0x0102'0408'1020'4081ULL >> 49) & 0x5555 |
           ((y * 0x0101'0101'0101'0101ULL & 0x8040'2010'0804'0201ULL) * 0x0102'0408'1020'4081ULL >> 48) & 0xAAAA;
}
