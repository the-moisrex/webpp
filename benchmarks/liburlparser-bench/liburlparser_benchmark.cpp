...
std::string_view getURI() noexcept {
    static constexpr std::array<std::string_view, 51> uri_list = {
      {"mailto:someone@example.com",
       ...
       "http://www.example.com/wpstyle/?p=364", "https://www.example.com/foo/?bar=baz&inga=42&quux",
       "http://✪df.ws/123", "http://userid:password@example.com:8080",
       ...
       "http://142.42.1.1:8080/", "http://➡.ws/䨹",
       "http://⌘.ws", "http://⌘.ws/",
       ...
       "http://☺.ha-ha.com/", "http://code.google.com/events/#&product=browser",
       "http://j.mp", "ftp://foo.bar/baz",
       "http://foo.bar/?q=Test%20URL-encoded%20stuff", "http://مثال.إختبار",
       "http://例子.测试", "http://उदाहरण.परीक्षा",
       "http://-.~_!$&()*+,;=:%40:80%2f::::::@example.com", "http://1337.net",
       "http://a.b-c.de", "http://223.255.255.254",
       "http://0.0.0.0", "http://10.1.1.0",
       "http://10.1.1.255", "http://224.1.1.1",
       "http://1.1.1.1.1", "http://123.123.123",
       "http://3628126748", "http://10.1.1.1",
       "http://10.1.1.254", "ftps://foo.bar/",
       "http://-error-.invalid/", "http://a.b--c.de/",
